...
namespace Microsoft.AspNetCore.Components.WebView.WebView2
{
	...
	public class WebView2WebViewManager : WebViewManager
	{
		...
		/// <param name="jsComponents">Describes configuration for adding, removing, and updating root components from JavaScript code.</param>
		/// <param name="hostPageRelativePath">Path to the host page within the <paramref name="fileProvider"/>.</param>
		/// <param name="dotvvmWebViewHandler">The <see cref="BlazorWebViewHandler" />.</param>
		public WebView2WebViewManager(
			WebView2Control webview!!,
			IServiceProvider services,
			Dispatcher dispatcher,
			...
			: base(services, dispatcher, new Uri(AppOrigin), fileProvider, new JSComponentConfigurationStore(), hostPageRelativePath)
		{
...
//#if WEBVIEW2_MAUI
//            var developerTools = _dotvvmWebViewHandler.DeveloperTools;
...
//#endif
		...
		/// </summary>
		protected virtual void QueueDotvvmStart()
		{
		}
		...
		private protected static string GetHeaderString(IHeaderDictionary headers) =>
